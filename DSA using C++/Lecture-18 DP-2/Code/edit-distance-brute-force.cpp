...
// Brute Force --> Time Compexity --> O(n^3);
/*
int editDistance(string s,string t){
    ...
    int x = editDistance(s,t.substr(1)) + 1;// remove 
    int y = editDistance(s.substr(1),t.substr(1)) + 1; // replace 
    int z = editDistance(s.substr(1),t) + 1; // insert
